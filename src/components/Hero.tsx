        ...
        <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden bg-dark">
            ...
            <div className="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-8xl font-black bg-gradient-to-r from-white via-gray-200 to-gray-500 bg-clip-text text-transparent tracking-tighter">
                        AJAI SELVARAJ
                    </h1>
                    ...
                    <div className="flex gap-4 pt-4">
                        ...
                        <MagneticButton
                            href="#contact"
                            className="border border-white/20 hover:bg-white/10 text-white px-8 py-3 rounded-full font-medium backdrop-blur-sm transition-all"
                        >
                            Hire Me
                        </MagneticButton>
                    </div>
